...
$stmt1 = $pdo->prepare("select * from services order by id desc limit $offset, $numOfrecs");
$stmt1->execute();
                ...
                <div class="col-12 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <a href="createservice.php" class="btn btn-success">Create</a>
                        </div>
                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="edit-service.php?id=<?php echo $value['id'] ?>" class="btn btn-primary">Edit</a>
                                                <a href="delete-service.php?id=<?php echo $value['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
                            ...
                            <nav class="d-inline-block">
                                <ul class="pagination mb-0">
                                    ...
                                    <li class="page-item disabled">
                                        <a class="page-link" href="#" tabindex="-1"><?php echo $page ?></a>
                                    </li>
