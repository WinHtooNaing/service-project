                ...
                <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    ?>
                            <div class="bg-light p-4">
                                ...
                                <h4 class="mb-3"><?php echo $values['title'] ?></h4>
                                <p><?php echo substr($values['description'], 0, 100) ?>...</p>
                                ...
                                <a href="service_details.php?id=<?php echo $values['id'] ?>" class="btn bg-white text-primary w-100 mt-2">Read More<i class="fa fa-arrow-right text-secondary ms-2"></i></a>
                            </div>
                        <?php
                        }
                    } else {
