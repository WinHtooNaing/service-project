...
$stmt1 = $pdo->prepare("select * from cities order by id desc limit $offset,$numOfrecs");
$stmt1->execute();
                ...
                <div class="col-12 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <a href="create-city.php" class="btn btn-success">Create</a>
                        </div>
                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php
                                            $id = $value['region_id'];
                                            $stmtRegion = $pdo->prepare('select region from regions where id=' . $id);
                                            $stmtRegion->execute();
                                            $resultRegion = $stmtRegion->fetch();
                                            ?>
                                            <td><?php echo $resultRegion['region'] ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($value['created_at'])) ?></td>

                                            <td><a href="edit-city.php?id=<?php echo $value['id'] ?>" class="btn btn-primary">Edit</a>
                                                <a href="delete-city.php?id=<?php echo $value['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
